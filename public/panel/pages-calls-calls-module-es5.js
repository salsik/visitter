...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-calls-calls-module"], {
  ...
  function srcAppPagesCallsCallsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CallsComponent_div_2_div_4_Template(rf, ctx) {
      if (rf & 1) {
        var _r31 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 27);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CallsComponent_div_2_div_4_Template_div_click_0_listener($event) {
          ...
          return ctx_r30.setSelectedCompany(item_r29.id);
        });
    ...
    function CallsComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CallsComponent_div_19_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("onClick", function CallsComponent_div_19_Template_dx_button_onClick_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r34);

          var r_r32 = ctx.$implicit;

          var ctx_r33 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r33.deleteItem(r_r32.data, $event);
        });
    ...
    function CallsComponent_div_20_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
    ...
    function CallsComponent_app_loader_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function (_calls_components_bas) {
      ...
      function CallsComponent(injector) {
        ...
        _this.rate = [];
        _this.companies = [];
        _this.selectedId = (_a = _this.authService.currentUser) === null || _a === void 0 ? void 0 : _a.company_id;
        return _this;
      }
      ...
      _createClass(CallsComponent, [{
        ...
        key: "deleteItem",
        value: function deleteItem(item, ev) {
                  ...
                  case 3:
                    ...
                    result.subscribe(function (res) {
                      if (res) {
                        ...
                        _this2.callsService.removeCall(item.id).subscribe(function (res) {
                          _this2.getCalls();
        ...
        value: function getCalls() {
          ...
          this.dataSource = new devextreme_data_data_source__WEBPACK_IMPORTED_MODULE_2___default.a({
            ...
            load: function load(loadOptions) {
              return _this3.callsService.getCalls(_this3.page, _this3.itemsCount, _this3.selectedId).toPromise().then(function (result) {
        ...
        value: function getCompanies() {
          ...
          this.isLoading = true;
          this.callsService.getCompanies().subscribe(function (res) {
            _this4.companies = res.content.data;
            _this4.selectedId = _this4.companies[0].id;
        ...
        key: "setSelectedCompany",
        value: function setSelectedCompany(id) {
          this.selectedId = id;
          this.page = 0;
          this.itemsCount = 10;
          this.getCalls();
    ...
    CallsComponent.ɵfac = function CallsComponent_Factory(t) {
      return new (t || CallsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"]));
    };
    ...
    CallsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 46,
      vars: 36,
      consts: [[1, "no-scroll"], [1, "row"], ["class", "col-md-2 col-sm-12 company-list", 4, "ngIf"], [1, "col-sm-12", 3, "ngClass"], [1, "datagrid", 3, "dataSource", "showBorders", "hoverStateEnabled", "noDataText", "showRowLines", "onRowClick"], [3, "text", "enabled"], [3, "groupPaging"], [3, "pageIndex", "pageSize", "pageIndexChange", "pageSizeChange"], [3, "showPageSizeSelector", "allowedPageSizes"], ["mode", "multiple"], ["dataField", "department.label", "alignment", "center", 3, "caption", "allowSorting"], ["dataField", "date", "cellTemplate", "dateTemplate", "alignment", "center", 3, "caption", "allowSorting"], ["dataField", "actions", "caption", "Actions", "alignment", "center", "cellTemplate", "actionTemplate", 3, "width", "allowSorting"], [4, "dxTemplate", "dxTemplateOf"], [4, "ngIf"], ["id", "showModal", "data-toggle", "modal", "data-target", "#default-modal", 2, "visibility", "hidden"], ["id", "default-modal", 1, "modal", "fade"], ["role", "document", 1, "modal-dialog"], [1, "modal-content"], [1, "modal-header"], [1, "modal-body"], [2, "width", "65%", "height", "277px", "object-fit", "contain", 3, "src"], [1, "modal-footer", "no-border"], [1, "text-right"], ["data-dismiss", "modal", 1, "btn", "btn-primary", "btn-md"], [1, "col-md-2", "col-sm-12", "company-list"], ["class", "company-item", 3, "ngClass", "click", 4, "ngFor", "ngForOf"], [1, "company-item", 3, "ngClass", "click"], ["icon", "trash", 1, "remove-btn", 3, "onClick"]],
      template: function CallsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("onRowClick", function CallsComponent_Template_dx_data_grid_onRowClick_4_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("pageIndexChange", function CallsComponent_Template_dxo_paging_pageIndexChange_9_listener($event) {
            return ctx.page = $event;
          })("pageSizeChange", function CallsComponent_Template_dxo_paging_pageSizeChange_9_listener($event) {
