...
const _c0 = ["ngForm"];
function AddCompanyComponent_app_loader_16_Template(rf, ctx) { if (rf & 1) {
...
AddCompanyComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AddCompanyComponent, selectors: [["app-add-company"]], viewQuery: function AddCompanyComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 17, vars: 3, consts: [[1, "ng-pristine", "ng-valid", "row", 3, "formGroup", "ngSubmit"], ["ngForm", "ngForm"], [1, "form-group", "col-md-6"], ["formControlName", "username", "type", "text", "placeholder", "Username", 1, "form-control"], ["formControlName", "login_id", "type", "text", "placeholder", "Login ID", 1, "form-control"], [1, "form-group", "col-md-12"], ["formControlName", "companyName", "type", "text", "placeholder", "Company Name", 1, "form-control"], ["formControlName", "email", "type", "email", "placeholder", "Email", 1, "form-control"], ["formControlName", "password", "type", "password", "placeholder", "Password", 1, "form-control"], [1, "mrg-top-20", "width-100", "text-right"], ["type", "submit", 1, "btn", "btn-info"], [4, "ngIf"]], template: function AddCompanyComponent_Template(rf, ctx) { if (rf & 1) {
